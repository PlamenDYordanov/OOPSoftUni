...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Controller controller = new ControllerImpl(motorcycleRepository, riderRepository, raceRepository); // TODO: new ControllerImpl(riderRepository, motorcycleRepository, raceRepository);
